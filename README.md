...
- **Board Skins**: Play on autodarts' drawn dartboard in another design
  - Five to choose from, each previewed in the settings — three to a row, two on a phone: **Default**, the board autodarts draws today, left exactly as it is; **Classic**, the board autodarts drew before its rebuild; **qwellcode**, a board with lime-green rings; **Opal**, mother-of-pearl segments on plum in a copper ring; and **Marble**, black and white marble veined with gold in a gilded rim
