...
### Changed
- Ported twelve of the eighteen Matches features to the rebuilt site, and checked the other six one by one
  ...
  - **Next Player On Takeout Stuck**, **Automatic Next Leg**, **Instant Replay** and **Streaming Mode** are unchanged and still disabled — each is driven by board events or the board camera, so none can be built or checked without a real board
